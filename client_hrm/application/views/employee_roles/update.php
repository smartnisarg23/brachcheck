        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <?php echo form_open(base_url('employee_roles/update/' . $record_id), array("class" => "form-horizontal")); ?>
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label">Details</label>
                        <div class="col-sm-10"><input type="text" class="form-control" name="r_comments" id="r_comments" value="<?= (isset($r_comments) && $r_comments != "") ? $r_comments : ""; ?>"></div>
                    </div>
                    <div class="hr-line-dashed"></div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-4 col-sm-offset-2">
                            <button class="btn btn-white" type="reset" onclick="window.location = '<?= base_url("employee_roles/index") ?>'">Cancel</button>
