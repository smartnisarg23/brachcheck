        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Update cost center</h5>
                </div>
                <div class="ibox-content">
                    <?php echo form_open(base_url('costcenter/update/' . $record_id), array("class" => "form-horizontal")); ?>
                        ...
                        <div class="col-sm-10">
                            <select class="form-control m-b" name="c_branch_id" id="c_branch_id">
                                ...
                                <?php foreach ($branches as $value) { ?>
                                    <option value="<?= $value["id"] ?>" <?= (isset($c_branch_id) && $c_branch_id == $value["id"]) ? "selected='selected'" : ""; ?> ><?= $value["b_name"] ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
