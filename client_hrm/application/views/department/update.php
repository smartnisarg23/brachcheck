        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <?php echo form_open(base_url('department/update/' . $record_id), array("class" => "form-horizontal")); ?>
                        ...
                        <div class="col-sm-10">
                            <select class="form-control m-b" name="d_branch_id" id="d_branch_id">
                                <?php foreach ($branches as $value) { ?>
                                    <option value="<?= $value["id"] ?>" <?= (isset($d_branch_id) && $d_branch_id == $value["id"]) ? "selected='selected'" : ""; ?> ><?= $value["b_name"] ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
