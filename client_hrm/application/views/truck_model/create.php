        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Create truck model</h5>
                </div>
                <div class="ibox-content">
                    <?php echo form_open(base_url('truck_model/create'), array("class" => "form-horizontal")); ?>
                    ...
                    <div class="form-group">
                        <div class="col-sm-4 col-sm-offset-2">
                            <button class="btn btn-white" type="reset" onclick="window.location = '<?= base_url("truck_make/index") ?>'">Cancel</button>
