        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <?php echo form_open(base_url('trucks/create'), array("class" => "form-horizontal")); ?>
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label">Truck model</label>
                        <div class="col-sm-10">
                            <select class="form-control m-b" name="t_model" id="t_model">
                                ...
                                <?php foreach ($t_models as $value) { ?>
                                    <option value="<?= $value["id"] ?>" <?= (isset($t_model) && $t_model == $value["id"]) ? "selected='selected'" : ""; ?> ><?= $value["t_model"] ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label">Logbook required?</label>
                        <div class="col-sm-10">
                            <input type="checkbox" class="i-checks set-permission" name="t_logbook" id="t_logbook">
                        </div>
                    </div>
                    <div class="hr-line-dashed"></div>
                    <div class="form-group"  id="data_1"><label class="col-sm-2 control-label">Last COF/WOF date</label>
                        <div class="col-sm-10">
                            <div class="input-group date">
                                ...
                                <input type="text" class="form-control" id="t_wof_date" name="t_wof_date" value="<?= (isset($t_wof_date) && $t_wof_date != "") ? $t_wof_date : ""; ?>" >
                            </div>
                        </div>
                    </div>
                    <div class="hr-line-dashed"></div>
